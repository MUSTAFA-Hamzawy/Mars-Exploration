...
void FormulationEvent::Set_Event_Day(int FD)
{
...
int FormulationEvent::Get_Event_Day()
{
...
bool FormulationEvent::Execute(		LinkedQueue<MountainousMission>& waitingMountainous,
...
FormulationEvent::FormulationEvent(const FormulationEvent& obj)
{
	...
	Target_Location = obj.Target_Location;
	 ...
	 Num_Of_Emergency_Missions = obj.Num_Of_Emergency_Missions;
	 Num_Of_Mountainous_Missions = obj.Num_Of_Mountainous_Missions;
	 Num_Of_Polar_Missions = obj.Num_Of_Polar_Missions;
}

void FormulationEvent::operator=(const FormulationEvent& obj)
{
	Formulation_Day = obj.Formulation_Day;
	Target_Location = obj.Target_Location;
	Mission_Duration = obj.Mission_Duration;
