...
private:
	...
	//create 3 arrays of events to store their data 
...
public:
	...
	void printfile(LinkedPriorityQueue<Mission> t1, int T_C_M, int T_E_M, int T_M_M, int T_P_M, int T_M, int T_E_R, int T_M_R, int T_P_R, int T_R, float avg_W, float avg_Ex, float Aut);
};
