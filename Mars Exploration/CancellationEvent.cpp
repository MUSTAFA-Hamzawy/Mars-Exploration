...
void CancellationEvent  ::Set_Event_Day(int CD)
{
...
int CancellationEvent  ::Get_Event_Day() 
{
	return Cancellation_Day;
}


int CancellationEvent  ::Get_ID() 
{
	return ID;
}
...
CancellationEvent::CancellationEvent(const CancellationEvent& obj)
{
	Cancellation_Day = obj.Cancellation_Day;
	ID = obj.ID;
	Num_Of_Mountainous_Missions = obj.Num_Of_Mountainous_Missions;
}

void CancellationEvent::operator=(const CancellationEvent& obj)
{
	Cancellation_Day = obj.Cancellation_Day;
	ID = obj.ID;
	Num_Of_Mountainous_Missions = obj.Num_Of_Mountainous_Missions;
